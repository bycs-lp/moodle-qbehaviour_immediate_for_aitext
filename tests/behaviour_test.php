...
/**
 * Unit tests for the immediate_for_aitext behaviour class.
 *
 * @package    qbehaviour_immediate_for_aitext
 * @category   test
 * @copyright  2026 ISB Bayern
...
final class behaviour_test extends \basic_testcase {
    ...
    public function test_apply_ai_results_to_step_writes_all_vars(): void {
        ...
        $behaviour = new testable_immediate_for_aitext();
    ...
    public function test_summarise_action_spellcheck_edit(): void {
        ...
        $this->assertSame(
            get_string('spellcheckeditaction', 'qbehaviour_immediate_for_aitext'),
            $summary
        );
    }
}
