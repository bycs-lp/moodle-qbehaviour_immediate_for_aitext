...
/**
 * Unit tests for the immediate_for_aitext behaviour type class.
 *
...
final class behaviour_type_test extends \basic_testcase {
    ...
    public function setUp(): void {
        parent::setUp();
        $this->behaviourtype = question_engine::get_behaviour_type('immediate_for_aitext');
    }
    ...
    public function test_can_questions_finish_during_the_attempt(): void {
        // Inherited from immediatefeedback — questions can be finished mid-attempt.
